...
- [CITA] "Solo hay un bus específico que me deja cerca de la universidad."
...
- [CITA] "Le escribí a una compañera para avisarle y que le dijera a la maestra que ya iba en camino."
- [CITA] "Adelanto lectura de alguna clase si puedo, o simplemente me quedo viendo el reloj."

## ❤️ SIENTE — emociones que mostró o nombró
- [CITA] "Llegué como veinticinco minutos tarde y la maestra ya había empezado."
- [CITA] "Me mojé esperando porque en la parada no hay dónde resguardarse."
- [CITA] "Ya no podía hacer nada más, solo esperar el bus y aguantarme el tráfico."

## ⚡ DOLORES — frustraciones, miedos, obstáculos
- [INF] Escasez de unidades de la ruta específica que necesita para llegar a la universidad.
- [INF] Tiempos de espera impredecibles que rompen su planificación diaria.
- [INF] Falta de infraestructura en las paradas (sin resguardo ante la lluvia).

## 🎁 GANANCIAS — qué sería "ganar" para esta persona
- [INF] Horarios de bus más frecuentes y confiables en su ruta.
- [INF] Menor tráfico en el trayecto hacia la universidad.
